        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p><strong>A house rental management system is a comprehensive software solution designed to streamline and automate the process of managing rental properties. It offers a centralized platform that enables property owners, landlords, and property managers to efficiently handle various aspects of their rental business.  The system facilitates tasks such as property listings, tenant screening, lease management, rent collection, maintenance tracking, and financial reporting. By utilizing this system, users can easily list available properties.</strong></p>
                    <hr>
                    <div class="row">
